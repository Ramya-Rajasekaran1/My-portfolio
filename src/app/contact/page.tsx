...
export default function ContactPage() {
    return (
        <main className="min-h-screen pt-24 pb-12 flex flex-col justify-center items-center overflow-hidden transition-colors duration-300 bg-neutral-50 dark:bg-neutral-950 relative z-20">
                                ...
                                <div className="flex flex-col items-center gap-4 w-full">
                                    ...
                                    <div className="flex flex-col items-center gap-1">
                                        ...
                                        <a
                                            ...
                                            className="flex items-center gap-2 text-xl font-bold font-outfit text-neutral-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors z-30 relative cursor-pointer"
                                        >
