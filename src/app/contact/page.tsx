        ...
        <main className="h-screen pt-24 pb-0 flex flex-col justify-center items-center overflow-hidden">
            <div className="container mx-auto px-4">
                <div className="max-w-2xl mx-auto text-center">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-6 tracking-tight">Get in Touch</h1>
                    <p className="text-lg md:text-xl text-neutral-600 dark:text-neutral-400 mb-12 font-sans">
                        ...
                        <div className="flex flex-col items-center gap-6">
                            ...
                            <div className="flex flex-col items-center gap-4 w-full">
                                <div className="flex flex-col items-center gap-1">
                                    <h2 className="text-xs font-bold font-outfit text-neutral-500 dark:text-neutral-400 uppercase tracking-widest">Email</h2>
                                ...
                                <div className="flex flex-col items-center gap-1">
                                    <h2 className="text-xs font-bold font-outfit text-neutral-500 dark:text-neutral-400 uppercase tracking-widest">LinkedIn</h2>
                                    <a
                                        href="https://www.linkedin.com/in/ramyar06/"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex items-center gap-2 text-xl font-bold font-outfit hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                                    >
                            ...
                            <p className="text-neutral-500 dark:text-neutral-400 text-xs mt-2 font-sans">
