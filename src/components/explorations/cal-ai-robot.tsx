...
interface CalAiRobotExplorationProps {
  exploration: Exploration;
}

export function CalAiRobotExploration({ exploration }: CalAiRobotExplorationProps) {
  const demoUrl = exploration.externalUrl || "https://calairobot.netlify.app";
