...
interface ResilienceInteractiveExplorationProps {
  exploration: Exploration;
}

export function ResilienceInteractiveExploration({ exploration }: ResilienceInteractiveExplorationProps) {
  const demoUrl = exploration.externalUrl || "https://resilienceinteractive.netlify.app";
