    ...
    return (
      ...
      `}</style>
            ...
            <section style={{ display: "grid", gridTemplateColumns: "1fr 1fr", minHeight: "100vh", paddingTop: 60 }}>
                ...
                <div style={{ background: "#0f0f0f", padding: "80px 60px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                    ...
                    <div>
                        ...
                        <h1 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(52px,6vw,88px)", fontWeight: 800, letterSpacing: "-0.02em", lineHeight: 1.1, color: "#fff", marginBottom: 32 }}>
                            Tracking<br /><em style={{ color: "#7c3aed", fontStyle: "italic", fontWeight: 800 }}>Quality</em>
                        </h1>
                ...
                <div style={{ background: "linear-gradient(135deg, #1e0a3c 0%, #0f0f1a 50%, #0a0a0a 100%)", padding: "80px 80px 80px 100px", display: "flex", flexDirection: "column", justifyContent: "center", position: "relative", overflow: "hidden", borderLeft: "1px solid rgba(124,58,237,0.2)" }}>
                    <div style={{ position: "absolute", top: 40, right: -20, fontFamily: "var(--font-outfit), sans-serif", fontSize: 140, fontWeight: 200, color: "rgba(255,255,255,0.04)", lineHeight: 0.9, whiteSpace: "pre", pointerEvents: "none" }}>{"TQ\nDATA"}</div>
                    <div style={{ position: "relative", zIndex: 2 }}>
                        <p style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(24px,3vw,40px)", fontWeight: 700, fontStyle: "italic", color: "#fff", lineHeight: 1.2, marginBottom: 32 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", background: "#111111", borderTop: "1px solid #272727", borderBottom: "1px solid #272727" }}>
                {[
                    { num: "01", title: "Actionable Clarity", text: <>Replace raw% numbers with <span style={{ color: "#a78bfa", fontWeight: 300 }}>ownership-based breakdowns</span> — so shippers know if the issue is theirs, the carrier's, or the platform's.</> },
            ...
            <section style={{ maxWidth: 1100, margin: "0 auto", padding: "100px 60px" }}>
                ...
                <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(42px,5vw,68px)", fontWeight: 200, lineHeight: 1.05, marginBottom: 40, color: "#fff" }}>
                    Too much data. <em style={{ fontStyle: "italic", color: "#FFF8F0", fontWeight: 400 }}>No one accountable.</em>
                </h2>
            ...
            <section style={{ background: "#111", padding: "100px 60px", borderBottom: "1px solid #272727" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 16, letterSpacing: "0.4em", textTransform: "uppercase", color: "#FFF8F0", display: "block", marginBottom: 20, fontWeight: 200 }}>02 CONTEXT</span>
                    <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(42px,5vw,68px)", fontWeight: 200, lineHeight: 1.05, marginBottom: 60, color: "#fff" }}>
                        Who felt the <em style={{ color: "#FFF8F0", fontStyle: "italic", fontWeight: 400 }}>pain</em>
                    </h2>

                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 40 }}>
                        {/* Target audiences */}
                        <div>
                            <h3 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 22, fontWeight: 300, color: "#fff", marginBottom: 20 }}>Target Audience</h3>
                        ...
                        <div style={{ background: "#0a0a0a", borderRadius: 16, padding: "32px", border: "1px solid #1f1f1f" }}>
                            <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 11, letterSpacing: "0.15em", textTransform: "uppercase", color: "#d1d5db", fontWeight: 700, display: "block", marginBottom: 16 }}>Sample User Story</span>
                            <p style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 17, fontStyle: "italic", color: "#fff", lineHeight: 1.7, marginBottom: 20, fontWeight: 300 }}>
            ...
            {/* ── HEURISTIC ANALYSIS ── */}
            <section style={{ maxWidth: 1100, margin: "0 auto", padding: "100px 60px" }}>
                <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 16, letterSpacing: "0.4em", textTransform: "uppercase", color: "#FFF8F0", display: "block", marginBottom: 20, fontWeight: 200 }}>03 AUDIT</span>
                <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(42px,5vw,68px)", fontWeight: 200, lineHeight: 1.05, marginBottom: 24, color: "#fff" }}>
                    Heuristic <em style={{ color: "#FFF8F0", fontStyle: "italic", fontWeight: 400 }}>Analysis</em>
                </h2>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 2, background: "#272727", marginBottom: 48 }}>
                    {[
                        ...
                        <div key={i.num} className="tq-card-hover" style={{ background: "#0a0a0a", padding: "32px 28px", transition: "background 0.2s" }}>
                            <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 12, color: "#d1d5db", fontWeight: 700, display: "block", marginBottom: 12 }}>{i.num}</span>
                            <h4 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 20, fontWeight: 300, color: "#fff", marginBottom: 10 }}>{i.label}</h4>
            ...
            <section style={{ background: "#111", padding: "100px 60px", borderBottom: "1px solid #272727" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 16, letterSpacing: "0.4em", textTransform: "uppercase", color: "#FFF8F0", display: "block", marginBottom: 20, fontWeight: 200 }}>04 RESEARCH</span>
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: 80, alignItems: "start" }}>
                        <div>
                            <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(36px,4vw,54px)", fontWeight: 200, lineHeight: 1.05, marginBottom: 24, color: "#fff" }}>
                                Qualitative <em style={{ color: "#FFF8F0", fontStyle: "italic", fontWeight: 400 }}>Feedback</em>
                            </h2>
            ...
            <section style={{ maxWidth: 1100, margin: "0 auto", padding: "100px 60px" }}>
                <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 16, letterSpacing: "0.4em", textTransform: "uppercase", color: "#FFF8F0", display: "block", marginBottom: 20, fontWeight: 200 }}>05 SYNTHESIS</span>
                <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(42px,5vw,68px)", fontWeight: 200, lineHeight: 1.05, marginBottom: 24, color: "#fff" }}>
                    Working towards <em style={{ color: "#FFF8F0", fontStyle: "italic", fontWeight: 400 }}>solutions</em>
                </h2>
                ...
                <div style={{ background: "#111", borderRadius: 16, padding: "28px 40px", border: "1px solid #1f1f1f", marginBottom: 48, textAlign: "center" }}>
                    ...
                    <code style={{ fontFamily: "ui-monospace, monospace", fontSize: 20, fontWeight: 700, color: "#FFF8F0", letterSpacing: "0.05em" }}>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 10, marginBottom: 56 }}>
                    {["Information Architecture", "Persona Use Cases", "Internal Stakeholder Testing", "User Stories", "Prototyping"].map(c => (
                        <span key={c} style={{ fontFamily: "ui-monospace, monospace", fontSize: 11, letterSpacing: "0.12em", textTransform: "uppercase", padding: "8px 16px", border: "1px solid rgba(255,255,255,0.2)", color: "#FFF8F0", borderRadius: 4, fontWeight: 300 }}>{c}</span>
                    ))}
                </div>
            ...
            <section style={{ background: "#111", padding: "100px 60px", borderBottom: "1px solid #272727" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 16, letterSpacing: "0.4em", textTransform: "uppercase", color: "#FFF8F0", display: "block", marginBottom: 20, fontWeight: 200 }}>06 IDEATION</span>
                    <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(42px,5vw,68px)", fontWeight: 200, lineHeight: 1.05, marginBottom: 24, color: "#fff" }}>
                        Ideation to <em style={{ color: "#FFF8F0", fontStyle: "italic", fontWeight: 400 }}>solutions</em>
                    </h2>
            ...
            {/* ── FIDELITY SCREENS ── */}
            <section style={{ maxWidth: 1100, margin: "0 auto", padding: "100px 60px" }}>
                <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 16, letterSpacing: "0.4em", textTransform: "uppercase", color: "#FFF8F0", display: "block", marginBottom: 20, fontWeight: 200 }}>07 DESIGN</span>
                <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(42px,5vw,68px)", fontWeight: 200, lineHeight: 1.05, marginBottom: 40, color: "#fff" }}>
                    Solutions to <em style={{ color: "#FFF8F0", fontStyle: "italic", fontWeight: 400 }}>fidelity</em>
                </h2>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 2, background: "#272727", marginBottom: 56 }}>
                    {[
                        ...
                        <div key={r.label} className="tq-card-hover" style={{ background: "#0a0a0a", padding: "32px 28px", transition: "background 0.2s" }}>
                            <h4 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 20, fontWeight: 300, color: "#fff", marginBottom: 10 }}>{r.label}</h4>
            ...
            <section style={{ background: "#111", padding: "100px 60px", borderBottom: "1px solid #272727" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 16, letterSpacing: "0.4em", textTransform: "uppercase", color: "#FFF8F0", display: "block", marginBottom: 20, fontWeight: 200 }}>08 IMPACT</span>
                    <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(42px,5vw,68px)", fontWeight: 200, lineHeight: 1.05, marginBottom: 60, color: "#fff" }}>
                        UX research <em style={{ color: "#FFF8F0", fontStyle: "italic", fontWeight: 400 }}>paid off</em>
                    </h2>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2, background: "#272727" }}>
                            {[
                                ...
                                <div key={m.label} style={{ background: "#1a1a1a", padding: "30px 20px", textAlign: "center" }}>
                                    <div style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 48, fontWeight: 200, color: "#7c3aed", lineHeight: 1, marginBottom: 8 }}>{m.num}</div>
                                    <div style={{ fontFamily: "ui-monospace, monospace", fontSize: 11, color: "#d1d5db", textTransform: "uppercase", letterSpacing: "0.1em", fontWeight: 300 }}>{m.label}</div>
                                </div>
                            ))}
                        </div>
            ...
            {/* ── KEY LEARNINGS ── */}
            <section style={{ maxWidth: 1100, margin: "0 auto", padding: "100px 60px" }}>
                <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 16, letterSpacing: "0.4em", textTransform: "uppercase", color: "#FFF8F0", display: "block", marginBottom: 20, fontWeight: 200 }}>09 REFLECTION</span>
                <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(42px,5vw,68px)", fontWeight: 200, lineHeight: 1.05, marginBottom: 60, color: "#fff" }}>
                    Key <em style={{ color: "#FFF8F0", fontStyle: "italic", fontWeight: 400 }}>learnings</em>
                </h2>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
                        {[
                            ...
                            <div key={l.num} style={{ display: "flex", gap: 20, alignItems: "flex-start" }}>
                                <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 14, color: "#FFF8F0", fontWeight: 200, minWidth: 28, paddingTop: 3 }}>{l.num}</span>
