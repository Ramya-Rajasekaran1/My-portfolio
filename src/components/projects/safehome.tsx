    ...
    <div className="flow-wrapper">
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1500, margin: "0 auto", padding: "0 60px", position: "relative", zIndex: 1 }}>
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(42px,5vw,68px)", fontWeight: 200, lineHeight: 1.05, marginBottom: 20, color: "#FFF8F0" }}>From technical portal to <em style={{ color: "#0070FF", fontStyle: "italic" }}>human centred safety tool</em></h2>
            <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 16, letterSpacing: "0.4em", textTransform: "uppercase", color: "#60a5fa", display: "block", marginBottom: 60, fontWeight: 200 }}>TRANSFORMATION</span>
          </div>

          {/* MOBILE INTERACTIONS SECTION */}
          <div style={{ marginBottom: 120, maxWidth: 1200, margin: "0 auto 120px" }}>
            <h3 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 32, fontWeight: 700, marginBottom: 40, color: "#FFF8F0" }}>Mobile Interactions</h3>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: 60, alignItems: "start" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
                <div style={{ background: "rgba(0,112,255,0.05)", border: "1px solid rgba(0,112,255,0.2)", borderRadius: 12, padding: "32px", height: "auto" }}>
                  <h4 style={{ fontFamily: "ui-monospace, monospace", fontSize: 14, color: "#60a5fa", textTransform: "uppercase", letterSpacing: "0.2em", marginBottom: 16, fontWeight: 200 }}>Notes</h4>
          ...
          {/* WEB SECTION */}
          <div>
            <h3 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 32, fontWeight: 700, marginBottom: 40, color: "#FFF8F0" }}>Web Experience</h3>
      ...
      <section style={{ background: "#111", padding: "100px 60px", borderBottom: "1px solid #272727" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 16, letterSpacing: "0.4em", textTransform: "uppercase", color: "#60a5fa", display: "block", marginBottom: 20, fontWeight: 200 }}>08 BEFORE & AFTER</span>
          <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(42px,5vw,68px)", fontWeight: 200, lineHeight: 1.05, marginBottom: 40, color: "#FFF8F0" }}>From technical data portal to <em style={{ color: "#0070FF", fontStyle: "italic" }}>human centred safety tool</em></h2>
          ...
          <div style={{ marginBottom: 80 }}>
            <h3 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 24, fontWeight: 700, margin: "0 0 12px", color: "#FFF8F0" }}>1. The Map & Risk Visualisation</h3>
          ...
          <div>
            <h3 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 24, fontWeight: 700, margin: "0 0 12px", color: "#FFF8F0" }}>2. Resource Navigation</h3>
  ...
  return (
    ...
    >
      ...
      <section style={{ display: "grid", gridTemplateColumns: "1fr 1fr", minHeight: "100vh", paddingTop: 60 }}>
        ...
        <div style={{ background: "#0f0f0f", padding: "80px 60px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
          ...
          <div>
            ...
            <h1 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(52px,6vw,88px)", fontWeight: 200, letterSpacing: "-0.02em", lineHeight: 0.95, color: "#FFF8F0", marginBottom: 32 }}>
              Safe<span style={{ color: "#0070FF", fontStyle: "italic", fontWeight: 400 }}>Home</span>
            </h1>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", background: "#111111", borderTop: "1px solid #272727", borderBottom: "1px solid #272727" }}>
        {[
          ...
          <div key={o.num} className="sh-card-hover" style={{ padding: "44px 40px", borderRight: "1px solid #272727", transition: "background 0.2s", cursor: "default" }}>
            <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 16, letterSpacing: "0.2em", textTransform: "uppercase", color: "#60a5fa", marginBottom: 8, display: "block", fontWeight: 200 }}>OBJECTIVE {o.num}</span>
            <h3 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 24, fontWeight: 700, marginBottom: 10, color: "#FFF8F0" }}>{o.title}</h3>
      ...
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "100px 60px" }}>
        <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 16, letterSpacing: "0.4em", textTransform: "uppercase", color: "#60a5fa", display: "block", marginBottom: 20, fontWeight: 200 }}>01 THE PROBLEM</span>
        <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(42px,5vw,68px)", fontWeight: 200, lineHeight: 1.05, marginBottom: 40, color: "#FFF8F0" }}>A product with mission but <em style={{ fontStyle: "italic", color: "#0070FF", fontWeight: 400 }}>no direction</em></h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "2px", background: "#222" }}>
          {[
            ...
            <div key={c.title} className="sh-card-hover" style={{ background: "#0a0a0a", padding: "32px", transition: "all 0.2s", display: "flex", flexDirection: "column", gap: "12px" }}>
              <h3 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 20, fontWeight: 700, color: "#FFF8F0", margin: 0 }}>{c.title}</h3>
      ...
      <section style={{ background: "#111", padding: "100px 60px", borderBottom: "1px solid #272727" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 16, letterSpacing: "0.4em", textTransform: "uppercase", color: "#60a5fa", display: "block", marginBottom: 20, fontWeight: 200 }}>02 ROLE & IMPACT</span>
          <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(42px,5vw,68px)", fontWeight: 200, lineHeight: 1.05, marginBottom: 32, color: "#FFF8F0" }}>Leadership & <em style={{ color: "#0070FF", fontStyle: "italic" }}>Results</em></h2>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2, background: "#272727" }}>
                {[
                  ...
                  <div key={s.title} style={{ background: "#0a0a0a", padding: "28px 24px" }}>
                    ...
                    <h3 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 18, fontWeight: 700, marginBottom: 8 }}>{s.title}</h3>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2, background: "#333" }}>
              {[
                ...
                <div key={m.label} style={{ background: "#1a1a1a", padding: "30px 20px", textAlign: "center" }}>
                  <div style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 42, fontWeight: 200, color: "#0070FF", lineHeight: 1, marginBottom: 4 }}>{m.num}</div>
      ...
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 60px 100px" }}>
        <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 16, letterSpacing: "0.4em", textTransform: "uppercase", color: "#60a5fa", display: "block", marginBottom: 20, fontWeight: 200 }}>05 UX INTERVENTION</span>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1.5fr", gap: 40, alignItems: "center", marginBottom: 80 }}>
          <div>
            <h3 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 24, fontWeight: 700, marginBottom: 16, color: "#FFF8F0" }}>Visual Analysis</h3>
        ...
        <div style={{ background: "#0f0f0f", borderRadius: 2, padding: "48px 44px", display: "grid", gridTemplateColumns: "1fr 1.5fr", gap: 40, alignItems: "center", border: "1px solid rgba(255,255,255,0.05)" }}>
          <div>
            <h3 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 26, fontWeight: 700, color: "#FFF8F0", marginBottom: 14, lineHeight: 1.2 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
              {[["#FF0000", "High"], ["#FF8C3B", "Medium"], ["#3BCC7A", "Low"]].map(([bg, label]) => (
                <div key={label} style={{ background: bg, color: "#FFF8F0", padding: "8px 20px", fontFamily: "ui-monospace, monospace", fontSize: 12, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", borderRadius: 2 }}>{label}</div>
              ))}
            </div>
          </div>
          <div style={{ position: "relative" }}>
          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32 }}>
              {[
                ...
                <div key={s.label}>
                  <div style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 36, fontWeight: 200, color: "#0070FF", lineHeight: 1, marginBottom: 4 }}>{s.num}</div>
      ...
      <section style={{ padding: "100px 60px", background: "#0a0a0a" }}>
        <div style={{ maxWidth: 1600, margin: "0 auto" }}>
          <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 16, letterSpacing: "0.4em", textTransform: "uppercase", color: "#60a5fa", display: "block", marginBottom: 20, fontWeight: 200 }}>FOUNDATION</span>
          <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(42px,5vw,68px)", fontWeight: 200, lineHeight: 1.05, marginBottom: 60, color: "#FFF8F0" }}>Creating a path <em style={{ color: "#0070FF", fontStyle: "italic" }}>forward</em></h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, marginBottom: 120 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
              <h3 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 28, fontWeight: 700, marginBottom: 24, color: "#FFF8F0" }}>Defining the Core Needs</h3>
              <p style={{ fontSize: 16, color: "#d1d5db", lineHeight: 1.7, marginBottom: 24 }}>
              ...
              <ul style={{ display: "flex", flexDirection: "column", gap: 16, listStyle: "none", padding: 0 }}>
                <li style={{ fontSize: 15, color: "#d1d5db", lineHeight: 1.6, position: "relative", paddingLeft: 24 }}>
                  ...
                  <strong style={{ color: "#0070FF", fontWeight: 200 }}>1. Risk Visibility (Awareness):</strong> Clear, building-level disaster risk information
                </li>
                <li style={{ fontSize: 15, color: "#d1d5db", lineHeight: 1.6, position: "relative", paddingLeft: 24 }}>
                  <span style={{ position: "absolute", left: 0, top: 0, color: "#0070FF", fontSize: "18px" }}>•</span>
                  <strong style={{ color: "#0070FF", fontWeight: 200 }}>2. Safety Evaluation (Comparison):</strong> Easy side-by-side apartment safety comparison
                </li>
                <li style={{ fontSize: 15, color: "#d1d5db", lineHeight: 1.6, position: "relative", paddingLeft: 24 }}>
                  <span style={{ position: "absolute", left: 0, top: 0, color: "#0070FF", fontSize: "18px" }}>•</span>
                  <strong style={{ color: "#0070FF", fontWeight: 200 }}>3. Action & Readiness (Preparation):</strong> Simple, actionable earthquake preparedness guidance
                </li>
                <li style={{ fontSize: 15, color: "#d1d5db", lineHeight: 1.6, position: "relative", paddingLeft: 24 }}>
                  <span style={{ position: "absolute", left: 0, top: 0, color: "#0070FF", fontSize: "18px" }}>•</span>
                  <strong style={{ color: "#0070FF", fontWeight: 200 }}>4. Local Support System (Community & Alerts):</strong> Real-time alerts, resources, and tenant rights clarity
                </li>
              </ul>
            </div>
          </div>
          ...
          <div style={{ marginBottom: "120px" }}>
            <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(32px,4vw,52px)", fontWeight: 200, lineHeight: 1.05, marginBottom: 40, color: "#FFF8F0" }}>Headstart to design system</h2>
            <div style={{ position: "relative" }}>
      ...
      <section style={{ padding: "100px 60px", background: "#0a0a0a" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 16, letterSpacing: "0.4em", textTransform: "uppercase", color: "#60a5fa", display: "block", marginBottom: 20, fontWeight: 200 }}>09 THE VISION</span>
          <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(42px,5vw,68px)", fontWeight: 200, lineHeight: 1.05, marginBottom: 40, color: "#FFF8F0" }}>MVP is the foundation. <em style={{ color: "#0070FF", fontStyle: "italic" }}>Here's what's next.</em></h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 2, background: "#272727" }}>
            {[
              ...
              <div key={v.title} className="sh-vision-card" style={{ background: "#111111", padding: "36px 28px", borderTop: `3px solid ${v.color}`, transition: "all 0.2s" }}>
                ...
                <h3 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 18, fontWeight: 700, marginBottom: 10, lineHeight: 1.2 }}>{v.title}</h3>
      ...
      <section style={{ background: "#0f0f0f", padding: "100px 60px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 16, letterSpacing: "0.4em", textTransform: "uppercase", color: "#60a5fa", display: "block", marginBottom: 20, fontWeight: 200 }}>10 CONSTRAINTS</span>
          <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(42px,5vw,68px)", fontWeight: 200, lineHeight: 1.05, marginBottom: 20, color: "#FFF8F0" }}>The harder parts and <em style={{ color: "#0070FF", fontStyle: "italic" }}>what I did with them</em></h2>
      ...
      {/* ── REFLECTION ── */}
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "100px 60px" }}>
        <span style={{ fontFamily: "ui-monospace, monospace", fontSize: 16, letterSpacing: "0.4em", textTransform: "uppercase", color: "#60a5fa", display: "block", marginBottom: 20, fontWeight: 200 }}>11 REFLECTION</span>
        <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: "clamp(42px,5vw,68px)", fontWeight: 200, lineHeight: 1.05, marginBottom: 52, color: "#FFF8F0" }}>What I learned leading through <em style={{ color: "#0070FF", fontStyle: "italic" }}>ambiguity</em></h2>

        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "start" }}>
          <div>
            <h3 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 24, fontWeight: 700, marginBottom: 16 }}>On Leadership</h3>
          ...
          <div>
            <h3 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 24, fontWeight: 700, marginBottom: 16 }}>On Constraints as Craft</h3>
      ...
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "60px" }}>
        <details style={{ background: "#111", borderRadius: 8, border: "1px solid rgba(255,255,255,0.05)", overflow: "hidden" }}>
          <summary style={{ padding: "30px 40px", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "space-between", listStyle: "none" }}>
            <h2 style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 28, fontWeight: 200, color: "#FFF8F0", margin: 0 }}>What I Led: 3-Week Redesign Sprint</h2>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20 }}>
              {[
                ...
                <div key={p.phase} style={{ background: "#1a1a1a", padding: "20px", borderRadius: 4 }}>
                  ...
                  <div style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 18, fontWeight: 700, color: "#FFF8F0", marginBottom: 8 }}>{p.title}</div>
