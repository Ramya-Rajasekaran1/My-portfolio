    ...
    return (
        <div className="space-y-4">
            {contentArray.map((line, index) => {
                ...
                if (isQuote) {
                    return (
                        <blockquote key={index} className={`border-l-4 border-[#B2577D] pl-6 py-2 my-6  text-xl ${textClass} bg-[#B2577D]/5 rounded-r-lg`}>
                            {cleanLine}
                        </blockquote>
                    );
                }
    ...
    return (
        <div className="space-y-4">
            {contentArray.map((item, index) => {
                ...
                if (isQuote) {
                    return (
                        <blockquote key={index} className="border-l-4 border-[#B2577D] pl-6 py-3 my-6  text-xl text-[#E9E8E8] bg-[#B2577D]/5 rounded-r-lg">
                            {cleanItem}
                        </blockquote>
                    );
                }
                ...
                return (
                    <div key={index} className="flex gap-4 items-start">
                        <span className="flex-shrink-0 w-1.5 h-1.5 rounded-full mt-2.5 bg-[#B2577D]" />
...
export function GenAiInclusivityProject({ project }: { project: Project }) {
    ...
    return (
        <main className="min-h-screen bg-[#080808] text-[#E9E8E8] font-sans selection:bg-[#B2577D]/30">
            <style jsx global>{`
                ...
                button.fixed.left-8.bottom-8 {
                    background-color: #B2577D !important;
                    border-color: rgba(87, 178, 140, 0.3) !important;
                    color: #000 !important;
                }
                
                /* Selection color */
                ::selection {
                    background: rgba(87, 178, 140, 0.3) !important;
                }
            ...
            <nav className="fixed inset-x-0 top-0 z-50 bg-[#080808]/90 backdrop-blur border-b border-neutral-900">
                <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                    <Link
                        href="/work"
                        className="inline-flex items-center gap-2 text-sm font-sans font-medium text-[#C4BFC1] hover:text-[#F4E5E9] transition-colors"
                    >
            ...
            <header className="relative min-h-[50vh] flex items-center border-b border-neutral-900 bg-[#080810] z-[30]">
                ...
                <div className="container mx-auto px-4 relative z-10 py-20">
                    <div className="max-w-2xl text-left space-y-6">
                        ...
                        <p className="text-lg md:text-xl font-sans font-light leading-relaxed text-[#C4BFC1] max-w-xl">
                            {project.description}
                        </p>
                    </div>
                </div>
                        ...
                        <div className="relative bg-black/95 border border-white/20 p-5 md:p-6 rounded-2xl flex items-center gap-6 shadow-[0_20px_80px_rgba(0,0,0,0.9)] backdrop-blur-3xl transition-all group-hover:border-blue-500/50 group-hover:scale-[1.02]">
                            <div className="flex flex-col items-center">
                                <div className="p-3 bg-blue-600 rounded-xl shadow-[0_0_25px_rgba(37,99,235,0.6)] mb-2 animate-pulse">
                                    <ShieldCheck className="w-5 h-5 md:w-6 md:h-6 text-[#F4E5E9]" />
                                </div>
            ...
            <article className="container mx-auto px-4 py-10 space-y-16">
                ...
                <section className="space-y-12 py-16 border-y border-neutral-800/50 w-full">
                    <header className="w-full flex flex-col items-center text-center space-y-6">
                        ...
                        <div className="flex flex-wrap justify-center gap-6 text-[0.72rem] font-mono text-[#A1979B] uppercase tracking-wider">
                        ...
                        <div className="flex flex-col md:flex-row h-auto md:h-[600px]">
                            ...
                            <div className="w-full md:w-64 bg-[#13151A] border-b md:border-b-0 md:border-r border-neutral-800/50 flex flex-row md:flex-col overflow-x-auto md:overflow-x-visible z-10 sticky top-0 md:static">
                                {['chatgpt', 'copilot', 'gemini'].map((platform) => {
                                    ...
                                    const dotColor = platform === 'chatgpt' ? '#B2577D' : platform === 'copilot' ? '#914364' : '#C37B99';
                            ...
                            <div className="flex-1 bg-[#0A0A0E] overflow-y-auto mac-scrollbar p-6 md:p-8 space-y-8">
                                ...
                                {activePlatform === 'chatgpt' && (
                                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="bg-[#13131A] border border-neutral-800/50 rounded-xl p-6 space-y-6 font-mono">
                                                ...
                                                <div className="space-y-3">
                                                    {[
                                                        { label: 'Under 60s', val: activeTask === 't1' ? 40.8 : 31.6, color: '#B2577D' },
                                                        { label: '1 – 3 min', val: activeTask === 't1' ? 38.2 : 39.5, color: '#B2577D80' },
                                        ...
                                        <div className="bg-[#B2577D]/10 border border-[#B2577D]/20 rounded-xl p-6 flex flex-col md:flex-row items-start md:items-center gap-4 group hover:bg-[#B2577D]/15 transition-all">
                                            <div className="p-3 bg-[#B2577D]/20 rounded-full shrink-0 group-hover:scale-110 transition-transform">
                ...
                <section className="max-w-5xl mx-auto mb-0 relative overflow-visible group py-16 mt-8">
                    <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[#B2577D]/10 blur-[150px] -z-10 animate-pulse transition-all duration-1000 group-hover:bg-[#B2577D]/20" />
                ...
                <section className="space-y-16 border-t border-neutral-800/50 pt-20">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                        ...
                        <div className="lg:col-span-4 flex items-center">
                            <p className="text-lg font-sans text-[#C4BFC1] leading-relaxed  border-l-2 border-blue-500/30 pl-8">
                    ...
                    <div ref={matrixRef} className="bg-[#0A0B10] rounded-[3.5rem] p-8 md:p-12 border border-neutral-800/50 shadow-2xl relative overflow-hidden">
                        ...
                        <div className="relative z-10 space-y-12">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {/* Gemini Card */}
                                <div className="bg-[#13151A]/50 border border-neutral-800/50 rounded-[2.5rem] p-8 flex flex-col group hover:border-[#B2577D]/30 transition-all duration-500 h-fit">
                                    ...
                                    <tbody className="text-sm">
                                        {[
                                            ...
                                            <tr key={i} className="hover:bg-white/[0.04] transition-all border-b border-neutral-800/10 group">
                                                <td className="py-4 px-6 font-normal text-[#F4E5E9] uppercase tracking-[0.05em] text-[0.8rem] group-hover:text-[#B2577D] transition-colors">{row.cat}</td>
                    ...
                    <div className="space-y-12 pt-16">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1 bg-neutral-800/20">
                            {[
                                ...
                                <div key={i} className="bg-neutral-900/60 p-10 border border-neutral-800/50 hover:bg-[#B2577D]/5 hover:border-[#B2577D]/40 transition-all group relative overflow-hidden">
                ...
                <section className="space-y-10 border-t border-neutral-800/50 pt-16 relative">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start relative">
                            ...
                            {findings.map((finding: any, idx: number) => (
                                <button
                                    ...
                                    className={`w-full px-8 py-6 rounded-2xl border text-left transition-all duration-500 group relative flex flex-col gap-3 ${selectedFinding === idx
                                        ? 'bg-[#13151A] border-[#B2577D] shadow-[0_0_30px_rgba(87,178,140,0.15)] ring-1 ring-[#B2577D]/50'
                                ...
                                >
                                    ...
                                    {selectedFinding === idx && (
                                        <div className="absolute right-[-4rem] top-1/2 w-16 border-t border-dotted border-[#B2577D]/40 hidden lg:block" />
                                    )}
                                </button>
                            ))}
                        </div>
                        ...
                        <div className="hidden lg:flex items-center justify-center lg:col-span-1 py-12 h-full absolute left-[33.33%] w-[8.33%] z-0">
                            <div className="w-px h-full border-l-2 border-dotted border-[#B2577D]/20" />
                        </div>

                        {/* Right Side: Finding Content */}
                        <div className="lg:col-span-7 lg:col-start-6 relative min-h-[400px]">
                            {findings[selectedFinding] && (
                                <div className="p-10 md:p-12 rounded-[2.5rem] bg-[#13151A] border border-[#B2577D]/30 shadow-[0_20px_60px_rgba(87,178,140,0.05)] animate-in fade-in slide-in-from-right-8 duration-700 relative overflow-hidden group">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch max-w-7xl mx-auto">
                                ...
                                <table className="w-full text-left border-collapse flex-1">
                                    <thead>
                                        <tr className="border-b border-neutral-800/50 bg-neutral-900/40">
                                            <th className="px-6 py-4 text-[0.75rem] font-mono uppercase tracking-[0.2em] text-[#C4BFC1]">App Platform</th>
                                            <th className="px-6 py-4 text-[0.75rem] font-mono uppercase tracking-[0.2em] text-[#C4BFC1] text-center">Theme</th>
                                            <th className="px-6 py-4 text-[0.75rem] font-mono uppercase tracking-[0.2em] text-[#C4BFC1] text-center">Language</th>
                                            <th className="px-6 py-4 text-[0.75rem] font-mono uppercase tracking-[0.2em] text-[#C4BFC1] text-center">Keyboard</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-neutral-800/30">
                                        {[
                                            { app: "ChatGPT", color: "#B2577D", data: ["79.2%", "75.5%", "57.6%"] },
                        ...
                        <div className="lg:col-span-6 space-y-6">
                            <div className="flex items-center gap-4 mb-4">
                                <h3 className="text-sm font-mono uppercase tracking-[0.3em] font-black text-[#C4BFC1]">Impact Visualizer</h3>
                            </div>
                            ...
                            <div className="bg-[#13151A] border border-neutral-800/50 rounded-[2.5rem] p-10 flex flex-col justify-between relative overflow-hidden group min-h-[450px]">
                                ...
                                <div className="flex-1 relative mt-4">
                                    ...
                                    <div className="absolute left-0 top-0 h-[80%] flex flex-col justify-around text-xs font-mono text-[#C4BFC1] uppercase tracking-widest pr-6 border-r border-neutral-800/50">
                                        <span>ChatGPT</span>
                                        <span>Copilot</span>
                                        <span>Gemini</span>
                                    </div>
                                    ...
                                    <div className="absolute left-24 bottom-0 w-[80%] flex justify-around text-xs font-mono text-[#C4BFC1] uppercase tracking-widest pt-6 border-t border-neutral-800/50">
                                        <span>Theme</span>
                                        <span>Language</span>
                                        <span>Keyboard</span>
                                    </div>
                                    ...
                                    <div className="absolute left-24 top-0 right-0 bottom-12 grid grid-cols-3 grid-rows-3 items-center justify-items-center">
                                        {[
                                            { val: 79.2, color: '#B2577D' }, { val: 75.5, color: '#B2577D' }, { val: 57.6, color: '#B2577D' },
                                            ...
                                            <div key={idx} className="relative group/bubble">
                                                ...
                                                >
                                                    <span className="text-[14px] md:text-[16px] font-mono font-black text-[#F4E5E9] drop-shadow-md">
                                                        {bubble.val}%
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    >
                                        ...
                                        <div className={`overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] ${isActive ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'}`}>
                                            <div className="px-8 pb-10 flex flex-col gap-6">
                                                <p className="text-[#F4E5E9] font-sans leading-relaxed">
                                                    {p.expanded}
                                                </p>
                ...
                <section className="pt-24 pb-12">
                    <div className="max-w-7xl mx-auto bg-gradient-to-br from-[#1A1C30] to-[#0A0B10] border border-[#B2577D]/30 rounded-[3.5rem] p-12 md:p-20 shadow-[0_40px_100px_rgba(0,0,0,0.6)] relative overflow-hidden group">
                        {/* Decorative background pattern */}
                        <div className="absolute inset-0 opacity-[0.03] pointer-events-none bg-[radial-gradient(#B2577D_1px,transparent_1px)] [background-size:20px_20px]" />
                        <div className="absolute -top-40 -right-40 w-[40rem] h-[40rem] bg-indigo-500/10 blur-[120px] rounded-full" />
                        <div className="absolute -bottom-40 -left-40 w-[40rem] h-[40rem] bg-[#B2577D]/10 blur-[120px] rounded-full" />
                        ...
                        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
                            ...
                            <div className="lg:col-span-7 space-y-10">
                                <div className="w-20 h-20 rounded-2xl bg-[#B2577D]/10 border border-[#B2577D]/30 flex items-center justify-center mb-4">
                                    <Target className="w-10 h-10 text-[#B2577D]" />
                                </div>
                ...
                <section className="pb-40 pt-24 border-t border-neutral-800/50 bg-[#080808]/50 overflow-hidden relative">
                    ...
                    <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#B2577D]/5 blur-[150px] -z-10" />
