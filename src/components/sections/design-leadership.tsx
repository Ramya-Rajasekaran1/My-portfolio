...
const galleryItems: GalleryItem[] = [
  ...
  { id: "madrasters-stairs", type: "image", src: `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/images/leadership/80A40B55-8E70-4BE0-8DA5-D745B97F08B4.JPG`, title: "Core Committee Member", location: "Global Venue", date: "Jan 2024", category: "Community", note: "Core Committee Member", tags: ["Madrasters", "Culture"], col: 1 },
  { id: "indiahci-2022-frame", type: "image", src: `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/images/leadership/6C165B99-D425-4DE1-BB5E-2FC08B680B9D.JPG`, title: "IndiaHCI 2022", location: "BITS Hyderabad", date: "Nov 2022", category: "Community", note: "India HCI Presentation", tags: ["Academic", "HCI"], col: 1 },
  // Col 2: Giving Back + Design Community
  { id: "mentorship-circle", type: "image", src: `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/images/leadership/bc6bbef4-1e89-44a7-987e-84d04c1129f5.jpg`, title: "Mentorship", location: "ADPList", date: "Jan 2024", category: "Community", note: "Giving Back", tags: ["ADPList", "Mentorship"], col: 2 },
  { id: "strategy-talk", type: "image", src: `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/images/leadership/6623beb2348122000855e532_1713618610056.JPG`, title: "Design Community", location: "Product Summit", date: "Jun 2023", category: "Community", note: "Design Community", tags: ["Product Strategy", "Leadership"], col: 2 },
  // Col 3: Events and Talks + India HCI Banner
  { id: "designmyx-collage", type: "image", src: `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/images/leadership/InShot_20231203_144932996.jpg`, title: "Events and Talks", location: "Zeta HQ", date: "Dec 2023", category: "Community", note: "Events and Talks", tags: ["Event", "Mentorship"], col: 3 },
  { id: "indiahci-banner", type: "image", src: `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/images/leadership/BA5F20C7-B944-44AA-A7EF-4543EDF3B36F.JPG`, title: "India HCI Presentation", location: "IndiaHCI '22", date: "Nov 2022", category: "Community", note: "India HCI Presentation", tags: ["Research", "Academic"], col: 3 },

  // Design Team (3rd Category)
  // Col 1: Design Fam
  { id: "madrasters-group", type: "image", src: `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/images/leadership/IMG-20220518-WA0051.jpg`, title: "Design Fam", location: "Madrasters HQ", date: "May 2022", category: "DesignTeam", note: "Design Fam", tags: ["Meetup", "Regional"], col: 1 },
  // Col 2: Team Boeing + Whiteboarding Days
  { id: "boeing-group-photo", type: "image", src: `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/images/leadership/C3EDEE2F-D8F6-4AA6-8A96-A3730B03BC62.JPG`, title: "Boeing Design Team", location: "Boeing India", date: "Oct 2023", category: "DesignTeam", note: "Team Boeing!", tags: ["Aviation", "Team"], col: 2 },
  { id: "strategy-board", type: "image", src: `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/images/leadership/CC423C12-E0DD-4880-8184-0E3C6DF52624.JPG`, title: "Systems Mapping", location: "Zeta HQ", date: "Sep 2023", category: "DesignTeam", note: "Whiteboarding Days", tags: ["Systems Design", "Workshop"], col: 2 },
  // Col 3: Leading at HQ
  { id: "hq-campus", type: "image", src: `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/images/leadership/78B30DBB-A0E1-4DE2-948F-6F133CB1DC15.JPG`, title: "Leading at HQ", location: "Global HQ", date: "Jan 2024", category: "DesignTeam", note: "Leading at HQ", tags: ["Enterprise", "Internal"], col: 3 },
];
