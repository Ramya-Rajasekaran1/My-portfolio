                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="relative group flex-1 pt-8">
                            <div className="absolute inset-0 bg-gradient-to-r from-blush/20 to-petal/10 rounded-3xl blur-xl group-hover:blur-2xl transition-all opacity-50"></div>
                            <a
                            ...
                            >
                                <div className="flex flex-col sm:flex-row gap-6 items-start">
                                    <div className="p-4 rounded-2xl bg-blush/10 border border-blush/20 shrink-0">
                                        <BookOpen className="w-8 h-8 text-blush" />
                                    </div>

                                    <div className="flex-1 space-y-4">
                                        <div className="flex items-start justify-between gap-4">
                                            <h3 className="text-xl font-medium text-white group-hover:text-petal transition-colors">
                            ...
                            {articles.map((article, idx) => (
                                <div key={idx} className="group relative">
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="block p-[12px] rounded-2xl bg-section border border-blush/10 backdrop-blur-md hover:bg-card transition-all group-hover:-translate-y-2 h-full"
                                    >
                                        <div className="flex justify-between items-start mb-4">
                                            <h3 className="text-lg font-medium text-white group-hover:text-petal transition-colors pr-8">{article.title}</h3>
                                            <ExternalLink className="w-4 h-4 text-petal opacity-0 group-hover:opacity-100 transition-opacity absolute right-4 top-4" />
                                        </div>
